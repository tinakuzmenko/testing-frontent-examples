 ...
 * library instead of CSS and class names) or even just rename CSS classes, tests will break.
 *
...
describe('ThemeSwitch Component', () => {
  test("shows 'Light' theme by default", () => {
    ...
    const wrapper = screen
      .getByRole('heading', { name: /example 1 - theme switch/i })
      .parentElement?.querySelector('.Wrapper');
